...
Public Class crEmpleadosxGenero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crEmpleadosxGenero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEmpleadosxGenero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEmpleadosxGenero = New crEmpleadosxGenero()
        rpt.Site = Me.Site
        Return rpt
    End Function
