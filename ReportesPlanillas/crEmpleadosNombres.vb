...
Public Class crEmpleadosNombres
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crEmpleadosNombres.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEmpleadosNombres
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEmpleadosNombres = New crEmpleadosNombres()
        rpt.Site = Me.Site
        Return rpt
    End Function
