...
Public Class crEmpleadosxCargo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crEmpleadosxCargo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEmpleadosxCargo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEmpleadosxCargo = New crEmpleadosxCargo()
        rpt.Site = Me.Site
        Return rpt
    End Function
