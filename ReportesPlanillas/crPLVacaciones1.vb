...
Public Class crPLVacaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crPLVacaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPLVacaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPLVacaciones = New crPLVacaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
