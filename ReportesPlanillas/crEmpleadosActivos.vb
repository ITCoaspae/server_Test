...
Public Class crEmpleadosActivos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crEmpleadosActivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEmpleadosActivos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEmpleadosActivos = New crEmpleadosActivos()
        rpt.Site = Me.Site
        Return rpt
    End Function
