...
Public Class crDetDesc_Boleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crDetDesc_Boleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetDesc_Boleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetDesc_Boleta = New crDetDesc_Boleta
        rpt.Site = Me.Site
        Return rpt
    End Function
