...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmMCobradores))
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(518, 100)
        Me.GroupBox2.TabIndex = 49
        Me.GroupBox2.TabStop = False
        Me.GroupBox2.Text = "Filtrar Gestor Por:"
        '
        'MetroButton1
        '
        Me.MetroButton1.Location = New System.Drawing.Point(427, 53)
        Me.MetroButton1.Name = "MetroButton1"
        Me.MetroButton1.Size = New System.Drawing.Size(75, 28)
        Me.MetroButton1.Style = MetroFramework.MetroColorStyle.Teal
        Me.MetroButton1.TabIndex = 56
        ...
        Me.txtDescripcion.Location = New System.Drawing.Point(350, 27)
        ...
        Me.txtCodigo.Location = New System.Drawing.Point(87, 28)
        ...
        Me.rbDescripcion.Location = New System.Drawing.Point(245, 24)
        Me.rbDescripcion.Name = "rbDescripcion"
        Me.rbDescripcion.Size = New System.Drawing.Size(99, 24)
        ...
        Me.rbCodigo.Size = New System.Drawing.Size(65, 24)
        ...
        'btnDel
        '
        Me.btnDel.Location = New System.Drawing.Point(185, 169)
        ...
        'btnAdd
        '
        Me.btnAdd.Location = New System.Drawing.Point(23, 169)
        ...
        Me.Name = "frmMCobradores"
        Me.ShowIcon = False
        Me.Style = MetroFramework.MetroColorStyle.Teal
        Me.Text = "Mantenimiento - Gestores de Cobros"
...
#End Region
    ...
    Private Sub ActualizaGrid()
        ...
        Try
            ...
            ds = oAsoc.ConsultarCobradoresxNombre("", sUsuario, sPassword, sSucursal)
            fg.DataSource = ds.Tables(0)
        Catch ex As Exception
            MessageBox.Show("Error en la recuperación de datos tabla Cobradores." & "System Error: " & ex.Message.ToString(), "Error de Aplicación", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        Encabezado()
    End Sub
    ...
    Private Sub frmMCobradores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ActualizaGrid()
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            Dim frm As frmMsCobradores = New frmMsCobradores
            frm.pAccion = "Agregar"
    ...
    Private Sub btnMod_Click(sender As Object, e As EventArgs) Handles btnMod.Click
        Try
            If fg.Row <> -1 Then
                ...
                frm.pCodigo = fg.Item(fg.Row, "CodCobrador")
                frm.StartPosition = FormStartPosition.CenterScreen
                frm.ShowDialog()
                ActualizaGrid()
                txtCodigo.Enabled = False
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        Try
            If fg.Row <> -1 Then
                If MsgBox("¿Desea eliminar el Cobrador seleccionado?", MsgBoxStyle.Question Or MsgBoxStyle.YesNo, "Eliminar Cobrador") = MsgBoxResult.Yes Then
                    Dim oAsoc As wrAsociados.wsLibAsoc = New wrAsociados.wsLibAsoc
                    oAsoc.EliminarCobradores("CodCobrador='" & fg.Item(fg.Row, "CodCobrador") & "'", sUsuario, sPassword, sSucursal)
                    ActualizaGrid()
                    txtCodigo.Enabled = False
                    txtDescripcion.Enabled = False
                End If
    ...
    Private Sub MetroButton1_Click(sender As Object, e As EventArgs) Handles MetroButton1.Click
        Try
            ...
            oAsoc = New wrAsociados.wsLibAsoc
            If rbCodigo.Checked = True Then
                ds = oAsoc.ConsultarCobradoresxNombre(Trim(txtCodigo.Text), sUsuario, sPassword, sSucursal)
            ElseIf rbDescripcion.Checked = True Then
                ds = oAsoc.ConsultarCobradoresxNombre("a.CodEmpleado like '" & Trim(txtDescripcion.Text) & "%'", sUsuario, sPassword, sSucursal)
