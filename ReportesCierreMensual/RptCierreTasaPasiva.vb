...
Public Class RptCierreTasaPasiva
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptCierreTasaPasiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.RptCierreTasaPasiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCierreTasaPasiva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCierreTasaPasiva = New RptCierreTasaPasiva
        rpt.Site = Me.Site
        Return rpt
    End Function
