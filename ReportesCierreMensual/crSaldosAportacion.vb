...
Public Class crSaldosAportacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crSaldosAportacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSaldosAportacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSaldosAportacion = New crSaldosAportacion
        rpt.Site = Me.Site
        Return rpt
    End Function
