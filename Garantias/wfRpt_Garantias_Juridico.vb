...
Public Class wfRPT_GARANTIAS_JURIDICO
    ...
    Protected Sub LLENAR_RPT(ByVal FECHA_INICIO As DateTime, ByVal FECHA_FIN As DateTime)
        ...
        DTS.Clear()
        DTS = CREDITO.RPT_GARANTIAS_X_DEPTO(sUsuario, sPassword, sSucursal, FECHA_INICIO, FECHA_FIN, 3)
        Dim RPT As New RPT_GARANTIAS_JURIDICO
        ...
        RPT.SetDataSource(DTS.Tables("SP_RPT_GARANTIAS_JURIDICO"))
