...
Public Class wfRPT_GARANTIAS_MERCADEO
    ...
    Protected Sub LLENAR_RPT(ByVal FECHA_INICIO As DateTime, ByVal FECHA_FIN As DateTime)
        ...
        DTS.Clear()
        DTS = CREDITO.RPT_GARANTIAS_X_DEPTO(sUsuario, sPassword, sSucursal, FECHA_INICIO, FECHA_FIN, 4)
        Dim RPT As New RPT_GARANTIAS_MERCADEO
        ...
        RPT.SetDataSource(DTS.Tables("SP_RPT_GARANTIAS_MERCADEO"))
    ...
    Private Sub wfRPT_GARANTIAS_MERCADEO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
