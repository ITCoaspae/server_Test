...
Public Class crPosteoHojaPar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crPosteoHojaPar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPosteoHojaPar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPosteoHojaPar = New crPosteoHojaPar()
        rpt.Site = Me.Site
        Return rpt
    End Function
