...
Public Class crContratoDPF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crContratoDPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrContratoDPF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crContratoDPF = New crContratoDPF()
        rpt.Site = Me.Site
        Return rpt
    End Function
