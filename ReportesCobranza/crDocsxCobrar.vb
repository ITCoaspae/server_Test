...
Public Class crDocsxCobrar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDocsxCobrar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDocsxCobrar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDocsxCobrar = New crDocsxCobrar()
        rpt.Site = Me.Site
        Return rpt
    End Function
