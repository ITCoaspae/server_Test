...
Public Class crDetalleCuotaRuta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDetalleCuotaRuta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetalleCuotaRuta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetalleCuotaRuta = New crDetalleCuotaRuta()
        rpt.Site = Me.Site
        Return rpt
    End Function
