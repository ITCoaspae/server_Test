...
Public Class crDocProtesto_Reserva1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crDocProtesto_Reserva.rpt"
        End Get
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crDocProtesto_Reserva.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
...
Public Class CachedcrDocProtesto_Reserva1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDocProtesto_Reserva = New crDocProtesto_Reserva
        rpt.Site = Me.Site
        Return rpt
    End Function
