...
Public Class crMora_Detalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crMora_Detalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMora_Detalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMora_Detalle = New crMora_Detalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
