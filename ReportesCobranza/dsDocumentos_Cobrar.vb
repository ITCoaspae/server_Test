...
Public Class dsDocumentos_Cobrar
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsDocumentos_Cobrar = CType(MyBase.Clone,dsDocumentos_Cobrar)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsDocumentos_Cobrar"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsDocumentos_Cobrar.xsd"
    ...
    Public Class DatosDataTable
        ...
        Public Overloads Function AddDatosRow(ByVal NoSocio As String, ByVal Dui As String, ByVal Nombres As String, ByVal CodPrestamo As String, ByVal Monto As Decimal, ByVal Saldo As Decimal, ByVal FechaOtorgamiento As Date, ByVal FechaVencimiento As Date, ByVal FechaUltPago As Date, ByVal Mora As Decimal, ByVal Cuota As Decimal, ByVal Plazo As Integer, ByVal DiasMora As Integer) As DatosRow
            Dim rowDatosRow As DatosRow = CType(Me.NewRow,DatosRow)
            rowDatosRow.ItemArray = New Object() {NoSocio, Dui, Nombres, CodPrestamo, Monto, Saldo, FechaOtorgamiento, FechaVencimiento, FechaUltPago, Mora, Cuota, Plazo, DiasMora}
