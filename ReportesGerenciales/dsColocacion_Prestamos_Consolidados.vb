...
Public Class dsColocacion_Prestamos_Consolidados
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsColocacion_Prestamos_Consolidados = CType(MyBase.Clone,dsColocacion_Prestamos_Consolidados)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsColocacion_Prestamos_Consolidados"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsColocacion_Prestamos_Consolidados.xsd"
