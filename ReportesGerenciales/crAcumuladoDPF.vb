...
Public Class crAcumuladoDPF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crAcumuladoDPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAcumuladoDPF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAcumuladoDPF = New crAcumuladoDPF()
        rpt.Site = Me.Site
        Return rpt
    End Function
