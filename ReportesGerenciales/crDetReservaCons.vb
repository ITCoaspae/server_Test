...
Public Class crDetReservaCons
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDetReservaCons.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetReservaCons
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetReservaCons = New crDetReservaCons()
        rpt.Site = Me.Site
        Return rpt
    End Function
