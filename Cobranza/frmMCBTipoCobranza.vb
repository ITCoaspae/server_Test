...
#End Region
    ...
    Private Sub Encabezado()
        ...
        fg.Cols.Item(2).Caption = "Día Inicio"
        fg.Cols.Item(3).Caption = "Día Fin"
        fg.Cols.Item(4).Caption = "Descripción"
        fg.Cols.Item(5).Caption = "Días Compromiso"
    ...
    Private Sub ActualizaGrid()
        ...
        Catch ex As Exception
            MessageBox.Show("Error en la recuperación de datos tabla Tipos de Cobranza" & "System Error: " & ex.Message.ToString(), "Error de Aplicación", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        Encabezado()
    End Sub
