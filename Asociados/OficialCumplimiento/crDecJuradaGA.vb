...
Public Class crDecJuradaGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDecJuradaGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDecJuradaGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDecJuradaGA = New crDecJuradaGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
