...
Public Class crSolicitudIngreso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crSolicitudIngreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSolicitudIngreso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSolicitudIngreso = New crSolicitudIngreso
        rpt.Site = Me.Site
        Return rpt
    End Function
