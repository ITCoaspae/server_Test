...
Public Class crRefPerSolIng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crRefPerSolIng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRefPerSolIng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRefPerSolIng = New crRefPerSolIng
        rpt.Site = Me.Site
        Return rpt
    End Function
