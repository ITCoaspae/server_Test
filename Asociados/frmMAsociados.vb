...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cbEstadoActual.Items.AddRange(New Object() {"(A)ctivo", "(R)etirado", "(I)nhabilitado", "(E)xcluído", "(F)allecido", "(N)inguno", "(G)Reingreso"})
        ...
        Me.cbEstadoIngreso.Items.AddRange(New Object() {"Candidato=no canceló cuota inicial", "Aspirante=canceló cuota inicial", "Asociado"})
