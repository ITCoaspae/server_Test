...
#End Region
    ...
    Private Sub frmMNivelBenef_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            MessageBox.Show("Error en la recuperación de datos tabla Niveles_CBeneficio" & "System Error: " & ex.Message.ToString(), "Error de Aplicación", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
