...
#End Region
    ...
    Private Sub Insertar()
        ...
        Else
            MsgBox("Cuenta Costos NO Agregada, error de validación o derechos de usuario", MsgBoxStyle.Critical, "Error de Validación/Derechos en Cuenta Costos")
        End If
    End Sub
    ...
    Private Sub Modificar()
        ...
        Else
            MsgBox("Cuenta Costos NO Modificada, error de validación o derechos de usuario", MsgBoxStyle.Critical, "Error de Validación/Derechos en Cuenta Costos")
        End If
    End Sub
    ...
    Private Sub Eliminar()
        ...
        Else
            MsgBox("Cuenta Costos NO Eliminada, error de validación o derechos de usuario", MsgBoxStyle.Critical, "Error de Validación/Derechos en Cuenta Costos")
        End If
    End Sub
