...
Public Class crActivoFijoxDepto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crActivoFijoxDepto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrActivoFijoxDepto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crActivoFijoxDepto = New crActivoFijoxDepto()
        rpt.Site = Me.Site
        Return rpt
    End Function
