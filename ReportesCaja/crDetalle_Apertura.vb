...
Public Class crDetalle_Apertura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDetalle_Apertura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetalle_Apertura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetalle_Apertura = New crDetalle_Apertura()
        rpt.Site = Me.Site
        Return rpt
    End Function
