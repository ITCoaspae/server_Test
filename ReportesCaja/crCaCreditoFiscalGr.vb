...
Public Class crCaCreditoFiscalGr
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCaCreditoFiscalGr.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCaCreditoFiscalGr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCaCreditoFiscalGr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCaCreditoFiscalGr = New crCaCreditoFiscalGr()
        rpt.Site = Me.Site
        Return rpt
    End Function
