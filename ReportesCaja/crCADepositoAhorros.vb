...
Public Class crCADepositoAhorros
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "crCADepositoAhorros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCADepositoAhorros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCADepositoAhorros = New crCADepositoAhorros
        rpt.Site = Me.Site
        Return rpt
    End Function
