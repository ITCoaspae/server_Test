...
Public Class crCaFacturaAp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCaFacturaAp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCaFacturaAp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCaFacturaAp = New crCaFacturaAp()
        rpt.Site = Me.Site
        Return rpt
    End Function
