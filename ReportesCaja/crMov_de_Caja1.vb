...
Public Class crMov_de_Caja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crMov_de_Caja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMov_de_Caja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMov_de_Caja = New crMov_de_Caja()
        rpt.Site = Me.Site
        Return rpt
    End Function
