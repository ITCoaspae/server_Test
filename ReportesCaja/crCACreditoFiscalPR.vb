...
Public Class crCACreditoFiscalPR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCACreditoFiscalPR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCACreditoFiscalPR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCACreditoFiscalPR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCACreditoFiscalPR = New crCACreditoFiscalPR()
        rpt.Site = Me.Site
        Return rpt
    End Function
