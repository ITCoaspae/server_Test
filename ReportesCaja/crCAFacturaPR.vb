...
Public Class crCAFacturaPR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCAFacturaPR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCAFacturaPR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCAFacturaPR = New crCAFacturaPR()
        rpt.Site = Me.Site
        Return rpt
    End Function
