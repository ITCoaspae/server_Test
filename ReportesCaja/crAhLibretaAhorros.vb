...
Public Class crAhLibretaAhorros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crAhLibretaAhorros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAhLibretaAhorros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAhLibretaAhorros = New crAhLibretaAhorros()
        rpt.Site = Me.Site
        Return rpt
    End Function
