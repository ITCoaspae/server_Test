...
Public Class crMovCajaxTransac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crMovCajaxTransac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMovCajaxTransac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMovCajaxTransac = New crMovCajaxTransac()
        rpt.Site = Me.Site
        Return rpt
    End Function
