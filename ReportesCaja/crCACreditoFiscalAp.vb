...
Public Class crCACreditoFiscalAp
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCACreditoFiscalAp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCACreditoFiscalAp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCACreditoFiscalAp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCACreditoFiscalAp = New crCACreditoFiscalAp()
        rpt.Site = Me.Site
        Return rpt
    End Function
