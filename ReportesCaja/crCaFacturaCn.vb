...
Public Class crCaFacturaCn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCaFacturaCn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCaFacturaCn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCaFacturaCn = New crCaFacturaCn()
        rpt.Site = Me.Site
        Return rpt
    End Function
