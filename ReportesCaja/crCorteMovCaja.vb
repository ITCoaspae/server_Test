...
Public Class crCorteMovCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCorteMovCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCorteMovCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCorteMovCaja = New crCorteMovCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
