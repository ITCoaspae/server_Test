...
Public Class crTransferencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crTransferencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrTransferencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTransferencias = New crTransferencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
