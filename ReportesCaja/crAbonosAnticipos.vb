...
Public Class crAbonosAnticipos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crAbonosAnticipos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAbonosAnticipos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAbonosAnticipos = New crAbonosAnticipos()
        rpt.Site = Me.Site
        Return rpt
    End Function
