...
Public Class crCaFacturaGr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCaFacturaGr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCaFacturaGr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCaFacturaGr = New crCaFacturaGr()
        rpt.Site = Me.Site
        Return rpt
    End Function
