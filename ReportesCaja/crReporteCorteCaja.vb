...
Public Class crReporteCorteCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crReporteCorteCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReporteCorteCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReporteCorteCaja = New crReporteCorteCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
