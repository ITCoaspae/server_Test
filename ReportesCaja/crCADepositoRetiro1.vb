...
Public Class crCADepositoRetiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCADepositoRetiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCADepositoRetiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCADepositoRetiro = New crCADepositoRetiro()
        rpt.Site = Me.Site
        Return rpt
    End Function
