...
Public Class crCheques_Anulados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCheques_Anulados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCheques_Anulados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCheques_Anulados = New crCheques_Anulados()
        rpt.Site = Me.Site
        Return rpt
    End Function
