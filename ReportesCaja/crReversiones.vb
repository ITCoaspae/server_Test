...
Public Class crReversiones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crReversiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReversiones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReversiones = New crReversiones()
        rpt.Site = Me.Site
        Return rpt
    End Function
