...
Public Class crAsociados_Mora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crAsociados_Mora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAsociados_Mora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAsociados_Mora = New crAsociados_Mora()
        rpt.Site = Me.Site
        Return rpt
    End Function
