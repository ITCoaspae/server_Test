...
Public Class crDividendosPr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDividendosPr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDividendosPr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDividendosPr = New crDividendosPr()
        rpt.Site = Me.Site
        Return rpt
    End Function
