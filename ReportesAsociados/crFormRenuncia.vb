...
Public Class crFormRenuncia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crFormRenuncia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFormRenuncia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFormRenuncia = New crFormRenuncia()
        rpt.Site = Me.Site
        Return rpt
    End Function
