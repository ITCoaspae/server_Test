...
Public Class crSaldosAsociado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crSaldosAsociado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSaldosAsociado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSaldosAsociado = New crSaldosAsociado()
        rpt.Site = Me.Site
        Return rpt
    End Function
