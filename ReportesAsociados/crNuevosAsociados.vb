...
Public Class crNuevosAsociados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crNuevosAsociados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrNuevosAsociados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crNuevosAsociados = New crNuevosAsociados()
        rpt.Site = Me.Site
        Return rpt
    End Function
