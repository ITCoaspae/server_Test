...
Public Class crDividendosAh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDividendosAh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDividendosAh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDividendosAh = New crDividendosAh()
        rpt.Site = Me.Site
        Return rpt
    End Function
