...
Public Class crDividendosRt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDividendosRt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDividendosRt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDividendosRt = New crDividendosRt()
        rpt.Site = Me.Site
        Return rpt
    End Function
