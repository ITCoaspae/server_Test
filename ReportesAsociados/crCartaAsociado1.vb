...
Public Class crCartaAsociado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCartaAsociado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCartaAsociado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCartaAsociado = New crCartaAsociado()
        rpt.Site = Me.Site
        Return rpt
    End Function
