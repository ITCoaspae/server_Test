...
Public Class crLiquidacionAsociado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crLiquidacionAsociado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crLiquidacionAsociado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLiquidacionAsociado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLiquidacionAsociado = New crLiquidacionAsociado()
        rpt.Site = Me.Site
        Return rpt
    End Function
