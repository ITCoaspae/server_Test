...
Public Class crDivNoCobrados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDivNoCobrados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDivNoCobrados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDivNoCobrados = New crDivNoCobrados()
        rpt.Site = Me.Site
        Return rpt
    End Function
