...
Public Class crCuentas_Pignoradas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCuentas_Pignoradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crCuentas_Pignoradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCuentas_Pignoradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCuentas_Pignoradas = New crCuentas_Pignoradas
        rpt.Site = Me.Site
        Return rpt
    End Function
