...
Public Class crCobroInactividad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crCobroInactividad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCobroInactividad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCobroInactividad = New crCobroInactividad
        rpt.Site = Me.Site
        Return rpt
    End Function
