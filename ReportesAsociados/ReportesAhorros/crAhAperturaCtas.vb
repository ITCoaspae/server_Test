...
Public Class crAhAperturaCtas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crAhAperturaCtas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAhAperturaCtas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAhAperturaCtas = New crAhAperturaCtas
        rpt.Site = Me.Site
        Return rpt
    End Function
