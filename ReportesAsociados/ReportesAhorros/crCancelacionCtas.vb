...
Public Class crCancelacionCtas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crCancelacionCtas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCancelacionCtas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCancelacionCtas = New crCancelacionCtas
        rpt.Site = Me.Site
        Return rpt
    End Function
