...
Public Class crDPFAnulados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crDPFAnulados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDPFAnulados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDPFAnulados = New crDPFAnulados
        rpt.Site = Me.Site
        Return rpt
    End Function
