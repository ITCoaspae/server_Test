...
Public Class crAhAperturaCtasDPF
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crAhAperturaCtasDPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crAhAperturaCtasDPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAhAperturaCtasDPF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAhAperturaCtasDPF = New crAhAperturaCtasDPF
        rpt.Site = Me.Site
        Return rpt
    End Function
