...
Public Class crVencimientos_DPF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crVencimientos_DPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrVencimientos_DPF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crVencimientos_DPF = New crVencimientos_DPF
        rpt.Site = Me.Site
        Return rpt
    End Function
