...
Public Class crCartera_DPF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crCartera DPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCartera_DPF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCartera_DPF = New crCartera_DPF
        rpt.Site = Me.Site
        Return rpt
    End Function
