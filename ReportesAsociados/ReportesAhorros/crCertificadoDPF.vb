...
Public Class crCertificadoDPF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crCertificadoDPF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCertificadoDPF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCertificadoDPF = New crCertificadoDPF
        rpt.Site = Me.Site
        Return rpt
    End Function
