...
Public Class crAhPosteoReverso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SysFinCoop.crAhPosteoReverso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAhPosteoReverso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAhPosteoReverso = New crAhPosteoReverso
        rpt.Site = Me.Site
        Return rpt
    End Function
