...
Public Class crAplicaciones_V_F_A
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "crAplicaciones V_F_A.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAplicaciones_V_F_A
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAplicaciones_V_F_A = New crAplicaciones_V_F_A
        rpt.Site = Me.Site
        Return rpt
    End Function
