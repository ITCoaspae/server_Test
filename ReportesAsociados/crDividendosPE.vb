...
Public Class crDividendosPE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDividendosPE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDividendosPE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDividendosPE = New crDividendosPE()
        rpt.Site = Me.Site
        Return rpt
    End Function
