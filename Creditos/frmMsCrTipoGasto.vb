...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnGuardar1
        '
        Me.btnGuardar1.Location = New System.Drawing.Point(287, 109)
        ...
        Me.MaximumSize = New System.Drawing.Size(380, 164)
        Me.MinimizeBox = False
        Me.MinimumSize = New System.Drawing.Size(380, 164)
        Me.Name = "frmMsCrTipoGasto"
    ...
    Private Sub frmMsTipoGarantia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If Me.pAccion = "Modificar" Then
                ...
                ds = oCred.ConsultarTipoGastos("*", "CodTipoGasto='" & pCodigo & "'", "CodTipoGasto", sUsuario, sPassword, sSucursal)
            ...
            Else
                Dim vCod As String
                vCod = oCred.ObtenerCorrelativoTipoGastos("CodTipoGasto", sUsuario, sPassword, sSucursal)
    ...
    Private Sub btnGuardar1_Click(sender As Object, e As EventArgs) Handles btnGuardar1.Click
        Try
            ...
            If Me.btnGuardar1.Text = "&Guardar" Then
                pCampos = "CodTipoGasto,Descripcion"
                pValores = "'" & Trim(txtCodigo.Text) & "','" & Trim(txtDescripcion.Text) & "'"
                If oCred.InsertarTipoGastos(pCampos, pValores, sUsuario, sPassword, sSucursal) = True Then
                    Me.Dispose()
                Else
                    MsgBox("El tipo de Gasto NO ha sido agregado. Verifíque e intente de nuevo.", MsgBoxStyle.Critical, "Error de Validación/Derechos en Módulo Créditos")
                End If
            ElseIf Me.btnGuardar1.Text = "&Modificar" Then
                pCampos = "Descripcion='" & Trim(txtDescripcion.Text) & "'"
                If oCred.ModificarTipoGastos(Trim(pCodigo), pCampos, sUsuario, sPassword, sSucursal) = True Then
                    Me.Dispose()
                Else
                    MsgBox("El tipo de Gasto no ha sido modificado. Verifíque e intente de nuevo.", MsgBoxStyle.Critical, "Error de Validación/Derechos en Módulo Créditos")
                End If
            End If
        Catch ex As Exception
             MetroFramework.MetroMessageBox.Show(Me, mensajeError, Me.Text, MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
