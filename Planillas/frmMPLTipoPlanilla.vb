Public Class frmMPLTipoPlanilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmMPLTipoPlanilla))
        ...
        Me.fg.Location = New System.Drawing.Point(23, 219)
        Me.fg.Name = "fg"
        Me.fg.Rows.Count = 2
        Me.fg.Size = New System.Drawing.Size(552, 136)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(487, 116)
        ...
        'btnMostrar1
        '
        Me.btnMostrar1.Location = New System.Drawing.Point(392, 80)
        Me.btnMostrar1.Name = "btnMostrar1"
        Me.btnMostrar1.Size = New System.Drawing.Size(75, 28)
        Me.btnMostrar1.Style = MetroFramework.MetroColorStyle.Teal
        Me.btnMostrar1.TabIndex = 116
        ...
        'txtCodTipoPersonal
        '
        Me.txtCodTipoPersonal.Location = New System.Drawing.Point(174, 28)
        ...
        'btnAdd
        '
        Me.btnAdd.Location = New System.Drawing.Point(23, 185)
        ...
        Me.Name = "frmMPLTipoPlanilla"
        Me.ShowIcon = False
        Me.ShowInTaskbar = False
        Me.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide
        Me.Style = MetroFramework.MetroColorStyle.Teal
        Me.Text = "Mantenimiento Tipos de Planilla"
...
#End Region
    ...
    Public Sub Encabezado()
        ...
        fg.Cols.Item(2).Caption = "Tipo de Planilla"
    ...
    Private Sub frmMPLTipoPlanilla_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ActualizarGrid()
    End Sub
    ...
    Private Sub btnMostrar1_Click(sender As Object, e As EventArgs) Handles btnMostrar1.Click
        ...
        Try
            If Me.rbtCodTipoPersonal.Checked = True Then
                Filtro = "CodTipoPlanilla LIKE '" & Trim(Me.txtCodTipoPersonal.Text) & "%'"
            ElseIf Me.rbtDesc.Checked = True Then
                Filtro = "Descripcion LIKE '" & Trim(Me.txtDesc.Text) & "%'"
            End If

            ds = oPlan.ConsultarPLTipoPlanilla("*", Filtro, "", sUsuario, sPassword, sSucursal)
            fg.DataSource = ds.Tables(0)
            Encabezado()
        Catch ex As Exception
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            Dim ofrm As New frmMsPLTipoPlanilla
    ...
    Private Sub btnMod_Click(sender As Object, e As EventArgs) Handles btnMod.Click
        If fg.Row <> -1 Then
            Try
                ...
                Dim dr As DataRow
                Dim ofrm As New frmMsPLTipoPlanilla
                ds = oPlan.ConsultarPLTipoPlanilla("*", "CodTipoPlanilla='" & Trim(fg.Item(fg.Row, "CodTipoPlanilla")) & "'", "", sUsuario, sPassword, sSucursal)
                dr = ds.Tables(0).Rows(0)
                ofrm.btnGuardar1.Text = "&Modificar"
                ofrm.txtCodTipoPlanilla.Text = IIf(IsDBNull(dr("CodTipoPlanilla")), "", dr("CodTipoPlanilla"))
                ofrm.txtCodTipoPlanilla.ReadOnly = True
                ofrm.txtDescripcion.Text = IIf(IsDBNull(dr("Descripcion")), "", dr("Descripcion"))
                ofrm.chkAFP.Checked = IIf(IsDBNull(dr("AFP")), False, dr("AFP"))
                ofrm.chkISSS.Checked = IIf(IsDBNull(dr("ISSS")), False, dr("ISSS"))
                ofrm.chkRenta.Checked = IIf(IsDBNull(dr("Renta")), False, dr("Renta"))
                ofrm.StartPosition = FormStartPosition.CenterScreen
                ofrm.ShowDialog()
                ActualizarGrid()
            Catch ex As Exception
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        If fg.Row <> -1 Then
            Try
                Dim var As Integer = oPlan.VerificarEliminarPLTipoPlanilla("'" & Trim(fg.Item(fg.Row, "CodTipoPlanilla")) & "'", sUsuario, sPassword, sSucursal)
                If var = 0 Then
                ...
                ElseIf var = 1 Then
                    If MsgBox("¿Está seguro de eliminar el registro?", MsgBoxStyle.YesNo, "Módulo - Planilla") = MsgBoxResult.Yes Then
                        If oPlan.EliminarPLTipoPlanilla("'" & Trim(fg.Item(fg.Row, "CodTipoPlanilla")) & "'", sUsuario, sPassword, sSucursal) = True Then
