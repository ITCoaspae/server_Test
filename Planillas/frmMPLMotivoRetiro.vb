...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.rbtCodRetiro.Text = "Código de Retiro:"
...
#End Region
    ...
    Public Sub Encabezado()
        fg.Cols.Item(1).Caption = "Código de Retiro"
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        If fg.Row <> -1 Then
            Try
                ...
                ElseIf var = 1 Then
                    If MsgBox("¿Está seguro de eliminar el registro?", MsgBoxStyle.Information, "Módulo - Planilla") = MsgBoxResult.Ok Then
