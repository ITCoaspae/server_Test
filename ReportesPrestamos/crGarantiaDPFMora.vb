...
Public Class crGarantiaDPFMora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crGarantiaDPFMora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrGarantiaDPFMora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crGarantiaDPFMora = New crGarantiaDPFMora()
        rpt.Site = Me.Site
        Return rpt
    End Function
