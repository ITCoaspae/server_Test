...
Public Class dsPRRepSaldosPrestamosxLinea
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsPRRepSaldosPrestamosxLinea = CType(MyBase.Clone,dsPRRepSaldosPrestamosxLinea)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsPRRepSaldosPrestamosxLinea"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsPRRepSaldosPrestamosxLinea.xsd"
    ...
    Public Class SaldosDataTable
        ...
        Private columnCodLineaCredito As DataColumn
        ...
        Friend ReadOnly Property CodLineaCreditoColumn As DataColumn
            Get
        ...
        Public Overloads Function AddSaldosRow(ByVal CodLineaCredito As String, ByVal Descripcion As String, ByVal Cantidad As Long, ByVal Saldo As Double) As SaldosRow
            Dim rowSaldosRow As SaldosRow = CType(Me.NewRow,SaldosRow)
            rowSaldosRow.ItemArray = New Object() {CodLineaCredito, Descripcion, Cantidad, Saldo}
        ...
        Friend Sub InitVars()
            Me.columnCodLineaCredito = Me.Columns("CodLineaCredito")
        ...
        Private Sub InitClass()
            Me.columnCodLineaCredito = New DataColumn("CodLineaCredito", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnCodLineaCredito)
    ...
    Public Class SaldosRow
        ...
        Public Property CodLineaCredito As String
            Get
                Try 
                    Return CType(Me(Me.tableSaldos.CodLineaCreditoColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSaldos.CodLineaCreditoColumn) = value
            End Set
        End Property
        ...
        Public Function IsCodLineaCreditoNull() As Boolean
            Return Me.IsNull(Me.tableSaldos.CodLineaCreditoColumn)
        End Function
        
        Public Sub SetCodLineaCreditoNull()
            Me(Me.tableSaldos.CodLineaCreditoColumn) = System.Convert.DBNull
        End Sub
