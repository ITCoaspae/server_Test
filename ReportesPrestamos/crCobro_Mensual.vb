...
Public Class crCobro_Mensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCobro_Mensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCobro_Mensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCobro_Mensual = New crCobro_Mensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
