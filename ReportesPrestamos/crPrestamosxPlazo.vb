...
Public Class crPrestamosxPlazo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crPrestamosxPlazo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPrestamosxPlazo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPrestamosxPlazo = New crPrestamosxPlazo()
        rpt.Site = Me.Site
        Return rpt
    End Function
