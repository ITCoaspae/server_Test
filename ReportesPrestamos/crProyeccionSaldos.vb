...
Public Class crProyeccionSaldos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crProyeccionSaldos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrProyeccionSaldos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crProyeccionSaldos = New crProyeccionSaldos()
        rpt.Site = Me.Site
        Return rpt
    End Function
