...
Public Class crCartaInformativa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCartaInformativa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCartaInformativa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCartaInformativa = New crCartaInformativa()
        rpt.Site = Me.Site
        Return rpt
    End Function
