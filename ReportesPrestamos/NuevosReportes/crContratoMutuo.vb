...
Public Class crContratoMutuo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crContratoMutuo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrContratoMutuo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crContratoMutuo = New crContratoMutuo()
        rpt.Site = Me.Site
        Return rpt
    End Function
