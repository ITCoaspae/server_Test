...
Public Class crDetallePrestamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDetallePrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetallePrestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetallePrestamo = New crDetallePrestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
