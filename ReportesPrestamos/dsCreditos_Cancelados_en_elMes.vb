...
Public Class dsCreditos_Cancelados_en_elMes
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsCreditos_Cancelados_en_elMes = CType(MyBase.Clone,dsCreditos_Cancelados_en_elMes)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsCreditos_Cancelados_en_elMes"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsCreditos_Cancelados_en_elMes.xsd"
    ...
    Public Class DatosDataTable
        ...
        Private columnMontoOtorgamiento As DataColumn
        
        Private columnMonto As DataColumn
        
        Private columnFechaCancelacion As DataColumn
        ...
        Friend ReadOnly Property MontoOtorgamientoColumn As DataColumn
            Get
                Return Me.columnMontoOtorgamiento
            End Get
        End Property
        ...
        Friend ReadOnly Property FechaCancelacionColumn As DataColumn
            Get
        ...
        Public Overloads Function AddDatosRow(ByVal Dui As String, ByVal NoSocio As String, ByVal Nombres As String, ByVal CodPrestamo As String, ByVal MontoOtorgamiento As Decimal, ByVal Monto As Decimal, ByVal FechaCancelacion As Date, ByVal FechaVencimiento As Date, ByVal CodTipoCredito As String, ByVal TipoCredito As String, ByVal Num As Integer) As DatosRow
            Dim rowDatosRow As DatosRow = CType(Me.NewRow,DatosRow)
            rowDatosRow.ItemArray = New Object() {Dui, NoSocio, Nombres, CodPrestamo, MontoOtorgamiento, Monto, FechaCancelacion, FechaVencimiento, CodTipoCredito, TipoCredito, Num}
        ...
        Friend Sub InitVars()
            ...
            Me.columnMontoOtorgamiento = Me.Columns("MontoOtorgamiento")
            Me.columnMonto = Me.Columns("Monto")
            Me.columnFechaCancelacion = Me.Columns("FechaCancelacion")
        ...
        Private Sub InitClass()
            ...
            Me.columnMontoOtorgamiento = New DataColumn("MontoOtorgamiento", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnMontoOtorgamiento)
            ...
            Me.columnFechaCancelacion = New DataColumn("FechaCancelacion", GetType(System.DateTime), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnFechaCancelacion)
    ...
    Public Class DatosRow
        ...
        Public Property MontoOtorgamiento As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableDatos.MontoOtorgamientoColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDatos.MontoOtorgamientoColumn) = value
            End Set
        End Property
        ...
        Public Function IsMontoOtorgamientoNull() As Boolean
            Return Me.IsNull(Me.tableDatos.MontoOtorgamientoColumn)
        End Function
        
        Public Sub SetMontoOtorgamientoNull()
            Me(Me.tableDatos.MontoOtorgamientoColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Sub SetFechaCancelacionNull()
            Me(Me.tableDatos.FechaCancelacionColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Sub SetNumNull()
            Me(Me.tableDatos.NumColumn) = System.Convert.DBNull
        End Sub
    End Class
