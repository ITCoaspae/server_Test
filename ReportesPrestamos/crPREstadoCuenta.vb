...
Public Class crPREstadoCuenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crPREstadoCuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPREstadoCuenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPREstadoCuenta = New crPREstadoCuenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
