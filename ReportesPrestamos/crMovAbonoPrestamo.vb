...
Public Class crMovAbonoPrestamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crMovAbonoPrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMovAbonoPrestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMovAbonoPrestamo = New crMovAbonoPrestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
