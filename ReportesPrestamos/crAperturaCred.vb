...
Public Class crAperturaCred
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crAperturaCred.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrAperturaCred
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crAperturaCred = New crAperturaCred()
        rpt.Site = Me.Site
        Return rpt
    End Function
