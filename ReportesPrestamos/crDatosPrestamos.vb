...
Public Class crDatosPrestamos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDatosPrestamos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDatosPrestamos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDatosPrestamos = New crDatosPrestamos()
        rpt.Site = Me.Site
        Return rpt
    End Function
