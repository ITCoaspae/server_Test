...
Public Class crRptTablaAmortiza
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crRptTablaAmortiza.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRptTablaAmortiza
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRptTablaAmortiza = New crRptTablaAmortiza()
        rpt.Site = Me.Site
        Return rpt
    End Function
