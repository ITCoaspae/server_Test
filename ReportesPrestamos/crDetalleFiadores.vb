...
Public Class crDetalleFiadores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDetalleFiadores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDetalleFiadores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDetalleFiadores = New crDetalleFiadores()
        rpt.Site = Me.Site
        Return rpt
    End Function
