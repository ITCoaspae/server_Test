...
Public Class crMora_porDias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crMora_porDias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMora_porDias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMora_porDias = New crMora_porDias()
        rpt.Site = Me.Site
        Return rpt
    End Function
