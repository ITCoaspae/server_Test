...
Public Class crHistCategoria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crHistCategoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrHistCategoria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crHistCategoria = New crHistCategoria()
        rpt.Site = Me.Site
        Return rpt
    End Function
