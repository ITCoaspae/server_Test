...
Public Class crDiarioMayor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crDiarioMayor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDiarioMayor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDiarioMayor = New crDiarioMayor()
        rpt.Site = Me.Site
        Return rpt
    End Function
