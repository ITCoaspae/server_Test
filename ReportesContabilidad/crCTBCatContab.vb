...
Public Class crCTBCatContab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCTBCatContab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCTBCatContab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCTBCatContab = New crCTBCatContab()
        rpt.Site = Me.Site
        Return rpt
    End Function
