...
Public Class crCTBBalComprob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIF_ERP.crCTBBalComprob.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCTBBalComprob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCTBBalComprob = New crCTBBalComprob()
        rpt.Site = Me.Site
        Return rpt
    End Function
