...
Public Class RPT_ESTADOR_RES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CONSOLIDADO_RPTCOOPAS.RPT_ESTADOR_RES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ESTADOR_RES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ESTADOR_RES = New RPT_ESTADOR_RES
        rpt.Site = Me.Site
        Return rpt
    End Function
